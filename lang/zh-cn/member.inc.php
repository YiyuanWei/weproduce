...
$L['op_trade_success'] = 'Order Completed';
$L['op_success'] = '操作成功';
...
$L['address_title'] = 'Delivery Address';
$L['address_title_add'] = 'New Address';
$L['address_title_edit'] = 'Edit Address';
$L['address_msg_choose'] = 'Choose';

$L['alert_pass'] = '您至少选择"关键字"或"所在行业"其中的一项';
$L['alert_title'] = '贸易提醒';
$L['alert_add_title'] = '添加提醒';

$L['ask_status'] = array('Pending', '<span style="color:blue;">Procssing</span>', '<span style="color:green;">Solved</span>', '<span style="color:red;">Not Resolved</span>');
$L['ask_title'] = '问题及解答';
...
$L['cash_status'] = array('<span style="color:blue;">Pending</span>', '<span style="color:#666666;">Refused</span>', '<span style="color:red;">Payment Failed</span>', '<span style="color:green;">Payment Success</span>');
...
$L['member_username_match'] = 'Bad Username Format';
$L['member_username_len'] = 'Username should has {V0}-{V1} characters.';
$L['member_username_ban'] = 'Username Banned';
$L['member_username_reg'] = 'Username Registered';
$L['member_passport_len'] = 'Nickname should has {V0}-{V1} characters.';
$L['member_passport_char'] = 'Nickname should has no special charatcters.';
$L['member_passport_ban'] = 'Nickname Banned';
$L['member_passport_reg'] = 'Nickname Repeated';
$L['member_password_null'] = 'Empty Password';
$L['member_password_match'] = 'Passwords do not match';
$L['member_password_len'] = 'Password should have {V0}-{V1} characters.';
$L['member_password_1'] = 'Password must contain numbers.';
$L['member_password_2'] = 'Password must contain lower case letters.';
$L['member_password_3'] = 'Password must contain UPPER CASE LETTERS.';
$L['member_password_4'] = 'Password must contain symbols';
$L['member_payword_null'] = 'Empty Payment Password';
$L['member_payword_match'] = 'Passwords do not match';
$L['member_payword_len'] = '支付密码长度应在{V0}-{V1}之间';
$L['member_groupid_null'] = '请选择会员组';
$L['member_truename_null'] = '请填写真实姓名';
$L['member_email_null'] = 'Please enter a valid Email Address.';
$L['member_email_ban'] = 'Banned Email Address';
$L['member_email_reg'] = 'Email Address Registered';
$L['member_mobile_null'] = '手机号码格式不正确';
$L['member_mobile_reg'] = '手机号码已经被注册';
$L['member_areaid_null'] = '请选择所在地区';
$L['member_company_null'] = '请填写公司名称';
...
$L['member_business_null'] = '请填写公司主要经营范围';
$L['member_catid_null'] = '请选择公司主营行业';
$L['member_login_username_bad'] = 'Bad Username Format';
$L['member_login_password_bad'] = 'Incorrect Password';
$L['member_login_not_member'] = '会员不存在';
$L['member_login_ban'] = 'Failed to login in the next {V0} hr(s) due to {V0} failed attempts.';
$L['member_login_member_ban'] = 'Banned Account';
$L['member_login_ok'] = 'Success';
$L['member_founder_del'] = '创始人不可删除';
$L['member_founder_move'] = '创始人不可移动';
$L['member_rename_not_member'] = '当前会员名不存在';
$L['member_record_reg'] = '注册奖励';
