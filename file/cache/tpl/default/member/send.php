...
<table cellpadding="10" cellspacing="1" class="tb">
<tr>
<td class="tl"><span class="f_red">*</span> 新<?php if($_userid) { ?>支付<?php } else { ?>登录<?php } ?>
密码</td>
<td class="tr"><input type="password" size="30" name="password" id="password" placeholder="新<?php if($_userid) { ?>支付<?php } else { ?>登录<?php } ?>
密码" onblur="validator();" autocomplete="off"/> <span id="dpassword" class="f_red"></span></td>
</tr>
<tr>
...
<td class="tr"><input type="text" size="30" name="mobile" id="mobile" value="<?php echo $mobile;?>" placeholder="已经认证的手机号码"<?php if($_userid && $mobile) { ?> readonly<?php } ?>
...
<td class="tr"><input type="text" size="30" name="email" id="email" value="<?php echo $email;?>" placeholder="注册时填写的邮箱地址"<?php if($_userid && $email) { ?> readonly<?php } ?>
