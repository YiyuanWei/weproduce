...
<select id="status" name="status" value="<?php echo $status;?>" onchange="input_note()">
...
<input id="note" style="display: none;" type="text" name="note">
<input type="hidden" name="oldnote" value="<?php echo $note;?>">
<br>
</form>
<script>
function input_note() {
var v = Dd('status').value;
if(v > 4 && v < 10){
