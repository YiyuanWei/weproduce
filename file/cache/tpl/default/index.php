...
<script>
    ...
    img.style = "grid-area: banner; z-index: 1; max-width: 100%; place-self: stretch";
    $("#banner").append(img);
</script>
<style>
  #about{
...
<div id="mall" class="wrapper">
  ...
  <div class="products">
    ...
    <div class="product clickable hide" id="product-<?php echo $t['itemid'];?>" onclick="showproduct('<?php echo $t['itemid'];?>')">
  ...
  <div class="btn" style="grid-area: more;">Show More</div>
</div>
